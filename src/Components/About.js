        ...
        <div className="code-editor">
          <pre>
            <code>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="variable">description</span>: <span className="string">"A diligent and highly motivated learner, specializing in cutting-edge technologies in software development, machine learning, and full-stack development."</span>, <br />


              &nbsp;&nbsp;<span className="keyword">if</span>(professional Experience): <br />
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="variable">IndustryExperience</span>: <span className="string">"Full Stack Developer with over 4 years of professional experience, I specialize in building scalable, high-performance applications that solve real-world problems."</span>, <br />
