...
const TAGS = ['HTML', 'CSS', 'JavaScript', 'Typescript', 'Tailwind CSS', 'React', 'NestJS', 'Git', 'VSCode', 'Jupyter Notebooks', 'Google Collab', 'D3.js', 'Tableau', 'GitHub'];
